...
config = TRLConfig(
    ...
    model=ModelConfig(model_path="EleutherAI/pythia-1.3b-deduped", num_layers_unfrozen=-1),
    tokenizer=TokenizerConfig(tokenizer_path="EleutherAI/pythia-1.3b-deduped", truncation_side="right"),
