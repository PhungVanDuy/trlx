...
config = TRLConfig(
    train=TrainConfig(
        ...
        checkpoint_dir="/mnt/hdd/duyphung/ilql_summarize_20B",
    ),
    model=ModelConfig(model_path="EleutherAI/gpt-neox-20b", num_layers_unfrozen=-1),
    tokenizer=TokenizerConfig(tokenizer_path="EleutherAI/gpt-neox-20b", truncation_side="right"),
    optimizer=OptimizerConfig(name="adamw", kwargs=dict(lr=1.0e-6, betas=(0.9, 0.95), eps=1.0e-8, weight_decay=1.0e-6)),
