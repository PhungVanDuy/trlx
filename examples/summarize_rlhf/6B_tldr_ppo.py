...
config = TRLConfig(
    train=TrainConfig(
        ...
        checkpoint_dir="ppo_pythia6b_sft_summarize_tldr_minibatched",
    ),
    model=ModelConfig(
        model_path="pvduy/pythia-6B-sft-summarize-tldr",
        num_layers_unfrozen=12,
    ),
    tokenizer=TokenizerConfig(
        tokenizer_path="pvduy/pythia-6B-sft-summarize-tldr",
...
def create_reward_fn():
    if os.environ.get("RANK", "0") == "0":
        ...
        lsh = pickle.load(open("6B_data/lsh_table_hashing.pickle", "rb"))
        post_summary_dict = pickle.load(open("6B_data/post_summary_dict.pickle", "rb"))
...
if __name__ == "__main__":
    ...
    if 0:
        ...
        train_prompts = pickle.load(open("6B_data/train_prompts.pickle", "rb"))
        val_prompts = pickle.load(open("6B_data/val_prompts.pickle", "rb"))
