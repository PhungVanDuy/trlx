...
config = TRLConfig(
    train=TrainConfig(
        ...
        checkpoint_dir="checkpoints/ilql_summarize_1B",
    ),
    model=ModelConfig(model_path="EleutherAI/pythia-125m-deduped", num_layers_unfrozen=-1),
    tokenizer=TokenizerConfig(tokenizer_path="EleutherAI/pythia-125m-deduped", truncation_side="right"),
